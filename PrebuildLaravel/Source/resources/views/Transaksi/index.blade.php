...
<h2 class="intro-y text-lg font-medium mt-10">List Data Transaksi</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('transaksicreate') }}"><button class="btn btn-primary shadow-md mr-2">
            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Tgl Transaksi</th>
                ...
                @foreach($data as $value)
                        <tr class="intro-x">
                            ...
                            <td>
                                <div class="text-slate-500">{{ $value['tgl_transaksi'] }}</div>
                            </td>
                            <td>
                                <div class="text-slate-500">{{ $value['pelangan'] }}</div>
                            </td>
                            <td>
                            ...
                            <td class="">
                                <div class="flex items-center justify-center {{ $value['harga'] }}">
                                     {{ $value['harga'] }}
                                </div>
                            </td>
                            <td class="">
